...
!(function(n) {
    n("html").removeClass("no-js"),
        ...
        n("#experience-timeline").each(function() {
            ...
            $userContent.each(function() {
                ...
                $this.find(".vtimeline-point").each(function() {
                    n(this).prepend(
                        '<div class="vtimeline-icon"><i class="fas fa-mobile-alt"></i></div>'
                    );
                }),
        ...
        n("#experience-timeline0").each(function() {
            ($this = n(this)),
            ($userContent = $this.children("div")),
            $userContent.each(function() {
                    n(this)
                ...
                $this.find(".vtimeline-point").each(function() {
                    n(this).prepend(
                        '<div class="vtimeline-icon"><i class="fab fa-wpforms"></i></i</div>'
                    );
                }),
        ...
        n("#experience-timeline1").each(function() {
            ($this = n(this)),
            ($userContent = $this.children("div")),
            $userContent.each(function() {
                    n(this)
                ...
                $this.find(".vtimeline-point").each(function() {
                    n(this).prepend(
                        '<div class="vtimeline-icon"><i class="fas fa-code"></i></i</div>'
